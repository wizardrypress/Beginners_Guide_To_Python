...
def display_help(board):
    print("""
Tic-Tac-Toe ek simple aur fun game hai. Do players 3 x 3 grid me turn
lekar "X" ya "O" mark karte hain.

Goal hai ki horizontal, vertical, ya diagonal line me sabse pehle apne
teen symbols lagaye jayein.

Khelne ke liye apni turn par khali position ka number enter karo.
Opponent ko block karo aur apni line complete karne ki koshish karo.
